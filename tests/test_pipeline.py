...
from mcp_data.backends.base import QueryError
from mcp_data.pipeline import run_sql_pipeline


def test_pipeline_serializes_result(backend: SQLiteSource) -> None:
...
def test_pipeline_rejects_mutation(backend: SQLiteSource) -> None:
